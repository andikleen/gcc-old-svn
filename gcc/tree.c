...
static void type_hash_list (const_tree, type_incr_hash &);
static void attribute_hash_list (const_tree, type_incr_hash &);
...
static void
type_hash_list (const_tree list, type_incr_hash &hstate)
{
  const_tree tail;
...
static void
attribute_hash_list (const_tree list, type_incr_hash &hstate)
{
  const_tree tail;
...
void
iterative_hstate_expr (const_tree t, type_incr_hash &hstate)
{
  int i;
  enum tree_code code;
